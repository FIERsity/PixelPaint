...
- 默认使用像素专用背景处理：边缘背景采样、OKLab 色差和 4 连通区域
- 支持连通背景与全局相近色两种处理范围，以及可调颜色容差
- 浏览器本地 AI 处理背景作为复杂背景的备用方案
- 像素硬边或柔和边缘
...
- Optional local AI background processing for complex backgrounds
